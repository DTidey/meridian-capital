...
risk_log = sa.Table(
    ...
    sa.Column(
        "check_type", sa.String, nullable=False
    ),  # e.g. 'pre_trade', 'circuit_breaker', 'tail_risk'
...
risk_events = sa.Table(
    ...
    ),  # e.g. 'SIZE_DOWN_30','CLOSE_ALL','KILL_SWITCH','REDUCE_GROSS_20','REDUCE_GROSS_50','FORCE_CLOSE'
