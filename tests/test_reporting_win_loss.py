...
from reporting.win_loss import compute, _stats, _streaks
...
def _make_trade(ticker, direction, pnl, holding_days=10, sector="Tech",
                entry_vix=18.0, entry_score=75.0,
                entry_date="2026-01-01", exit_date="2026-01-11",
