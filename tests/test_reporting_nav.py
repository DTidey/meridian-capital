...
def test_build_nav_series_known_values(engine):
    ...
    hist_rows = [
        {"snapshot_date": "2026-01-01", "ticker": "AAPL", "direction": "LONG",
         "shares": 100.0, "price": 100.0, "market_value": 10000.0, "weight": 0.10,
         "unrealized_pnl": 500.0, "sector": "Technology", "combined_score": 80.0,
         "recorded_at": "2026-01-01T00:00:00"},
        {"snapshot_date": "2026-01-02", "ticker": "AAPL", "direction": "LONG",
         "shares": 100.0, "price": 101.0, "market_value": 10100.0, "weight": 0.10,
         "unrealized_pnl": 600.0, "sector": "Technology", "combined_score": 80.0,
         "recorded_at": "2026-01-02T00:00:00"},
        {"snapshot_date": "2026-01-03", "ticker": "AAPL", "direction": "LONG",
         "shares": 100.0, "price": 99.0, "market_value": 9900.0, "weight": 0.10,
         "unrealized_pnl": 400.0, "sector": "Technology", "combined_score": 80.0,
...
def test_drawdown_calculation(engine):
    ...
    hist_rows = [
        {"snapshot_date": "2026-01-01", "ticker": "AAPL", "direction": "LONG",
         "shares": 100.0, "price": 100.0, "market_value": 10000.0, "weight": 0.10,
         "unrealized_pnl": 0.0, "sector": "Technology", "combined_score": 80.0,
         "recorded_at": "2026-01-01T00:00:00"},
        {"snapshot_date": "2026-01-02", "ticker": "AAPL", "direction": "LONG",
         "shares": 100.0, "price": 110.0, "market_value": 11000.0, "weight": 0.10,
         "unrealized_pnl": 1000.0, "sector": "Technology", "combined_score": 80.0,
         "recorded_at": "2026-01-02T00:00:00"},
        {"snapshot_date": "2026-01-03", "ticker": "AAPL", "direction": "LONG",
         "shares": 100.0, "price": 90.0, "market_value": 9000.0, "weight": 0.10,
         "unrealized_pnl": -1000.0, "sector": "Technology", "combined_score": 80.0,
         "recorded_at": "2026-01-03T00:00:00"},
    ]
    with engine.begin() as conn:
...
def test_nav_persisted_to_table(engine):
    ...
    hist_rows = [
        {"snapshot_date": "2026-02-01", "ticker": "MSFT", "direction": "LONG",
         "shares": 50.0, "price": 200.0, "market_value": 10000.0, "weight": 0.10,
         "unrealized_pnl": 250.0, "sector": "Technology", "combined_score": 75.0,
